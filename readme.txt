...
Install Tiny Bar as a regular WordPress plugin. Here are different ways to install this plugin:
...
1. Download the latest version of Tiny Bar (.zip file)
2. In your Admin, go to menu Plugins > Add New
3. Select "Upload Plugin"
4. Click on "Choose File"
5. Select downloaded tiny-bar.zip and click on "Install Now" button
...
After successful installation you will see a Tiny Bar menu in admin section. Fill the necessary options and your display bar will be ready. 

= Any planning to add more options? =
...
= 1.2 =
* POT file included (/languages/)
* Deafault bar will show at top upon activation
* Code changes and improved
